...
import jawampa.client.ClientConfiguration;
import jawampa.client.SessionEstablishedState;
import jawampa.client.StateController;
import jawampa.internal.ArgArrayBuilder;
import jawampa.internal.UriValidator;
import jawampa.internal.Promise;
...
public class WampClient {
    ...
    public Observable<Request> registerProcedure(final String topic, final EnumSet<RegisterFlags> flags) {
        return Observable.unsafeCreate(new OnSubscribe<Request>() {
            @Override
    ...
    public Observable<PubSubData> makeSubscription(final String topic, final SubscriptionFlags flags) {
        return Observable.unsafeCreate(new OnSubscribe<PubSubData>() {
            @Override
