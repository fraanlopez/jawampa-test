...
import jawampa.connection.IConnectionController;
import jawampa.connection.IWampConnectionPromise;
import jawampa.internal.IdValidator;
import jawampa.ApplicationError;
import jawampa.CallFlags;
import jawampa.PubSubData;
import jawampa.PublishFlags;
import jawampa.RegisterFlags;
import jawampa.Reply;
import jawampa.Request;
import jawampa.SubscriptionFlags;
import jawampa.WampClient;
import jawampa.WampMessages;
import jawampa.WampRoles;
import jawampa.WampMessages.AbortMessage;
import jawampa.WampMessages.CallMessage;
import jawampa.WampMessages.ChallengeMessage;
import jawampa.WampMessages.ErrorMessage;
import jawampa.WampMessages.EventMessage;
import jawampa.WampMessages.GoodbyeMessage;
import jawampa.WampMessages.InvocationMessage;
import jawampa.WampMessages.PublishedMessage;
import jawampa.WampMessages.RegisterMessage;
import jawampa.WampMessages.RegisteredMessage;
import jawampa.WampMessages.ResultMessage;
import jawampa.WampMessages.SubscribeMessage;
import jawampa.WampMessages.SubscribedMessage;
import jawampa.WampMessages.UnregisterMessage;
import jawampa.WampMessages.UnregisteredMessage;
import jawampa.WampMessages.UnsubscribeMessage;
import jawampa.WampMessages.UnsubscribedMessage;
import jawampa.WampMessages.WampMessage;
import jawampa.WampMessages.WelcomeMessage;
import jawampa.internal.IdGenerator;
...
public class SessionEstablishedState implements ClientState {
    ...
    public void performRegisterProcedure(final String topic, final EnumSet<RegisterFlags> flags,
        ...
        ObjectNode options = stateController.clientConfig().objectMapper().createObjectNode();
        if (flags != null) {
        	// it configures the registration flags for a procedure
            for (RegisterFlags flag : flags) {
            	options.put(flag.getKey(), flag.getValue());
			}
        }
