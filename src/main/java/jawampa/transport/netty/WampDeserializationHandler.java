...
public class WampDeserializationHandler extends MessageToMessageDecoder<WebSocketFrame> {
        ...
        throws Exception 
    {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            InputStream inputTextFrame = new ByteBufInputStream(textFrame.content());
            ArrayNode arr = objectMapper.readValue( inputTextFrame, ArrayNode.class);
            ...
            // If we receive an invalid frame on of the following functions will throw
            // This will lead Netty to closing the connection
            InputStream inputBinaryFrame = new ByteBufInputStream(binaryFrame.content());
            ArrayNode arr = objectMapper.readValue( inputBinaryFrame, ArrayNode.class);
